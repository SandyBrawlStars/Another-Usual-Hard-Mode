...
enum GameMode
{
    ...
    GAMEMODE_UPSELL,
    GAMEMODE_INTRO,
    GAMEMODE_EXPANSION_STAGE_1,
    GAMEMODE_EXPANSION_STAGE_2,
    GAMEMODE_EXPANSION_STAGE_3,
    GAMEMODE_EXPANSION_STAGE_4,
    GAMEMODE_EXPANSION_STAGE_5,
    GAMEMODE_EXPANSION_STAGE_6,
    GAMEMODE_ARCADE_STAGE_1,
...
enum ProjectileType
{
    ...
    PROJECTILE_ELECTRO_PEA= 14,
    PROJECTILE_JACKBOX,
    PROJECTILE_BUCKET,
    PROJECTILE_ZOMBIE_CABBAGE,
    PROJECTILE_ZOMBIE_SNOWPEA,
    NUM_PROJECTILES,
};
...
enum ZombiePhase
{
    ...
    PHASE_GHOST_TRANSFORM,
    PHASE_GHOST_END,
    PHASE_NEWSPAPER_DIGGING,
};
enum ZombieType
{
    ...
    ENUM_AUTO_VALUE(ZOMBIE_CABBAGE_HEAD)
    ...
    ENUM_VALUE(NUM_ZOMBIES_IN_ALMANAC, NUM_ZOMBIE_TYPES)
};

enum ZombieVariant
{
    ENUM_VALUE(ZOMBIE_VARIANT_NONE, -1)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_DASHER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_GHOST)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_ENDER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_GARLIC)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_JACKVAULTER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_BUFFVAULTER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_DEFENDER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_BOOSTER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_CURSESHOOTER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_SNOWPEA)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_STARPAPER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_MINERPAPER)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_BOOSTDOOR)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_ABSORBDOOR)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_BURNINGSQUASH)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_DRAINSQUASH)
    ENUM_AUTO_VALUE(ZOMBIE_VARIANT_RAMSTAR)
    ENUM_AUTO_VALUE(NUM_ZOMBIE_VARIANTS)
};

enum PlantVariant
{
    ENUM_VALUE(SEED_VARIANT_NONE, -1)
    ENUM_AUTO_VALUE(SEED_VARIANT_FIREPEA)
    ENUM_AUTO_VALUE(SEED_VARIANT_ELECTROPEA)
    ENUM_AUTO_VALUE(SEED_VARIANT_SUNBLASTER)
    ENUM_AUTO_VALUE(SEED_VARIANT_HYPNOFLOWER)
    ENUM_AUTO_VALUE(SEED_VARIANT_CRYOCHERRY)
    ENUM_AUTO_VALUE(SEED_VARIANT_STARNUT)
    ENUM_AUTO_VALUE(SEED_VARIANT_HEALNUT)
    ENUM_AUTO_VALUE(SEED_VARIANT_MULTIMINE)
    ENUM_AUTO_VALUE(SEED_VARIANT_POISONPEA)
    ENUM_AUTO_VALUE(SEED_VARIANT_WINDPEA)
    ENUM_AUTO_VALUE(SEED_VARIANT_POISONCHOMPER)
    ENUM_AUTO_VALUE(SEED_VARIANT_FLAMECHOMPER)
    ENUM_AUTO_VALUE(SEED_VARIANT_PRIMALPEA)
    ENUM_AUTO_VALUE(SEED_VARIANT_DIVIDEPEA)
    ENUM_AUTO_VALUE(SEED_VARIANT_FREEZEPUFF)
    ENUM_AUTO_VALUE(SEED_VARIANT_BANKSHROOM)
    ENUM_AUTO_VALUE(SEED_VARIANT_INFECTSHROOM)
    ENUM_AUTO_VALUE(SEED_VARIANT_BUFFSHROOM)
    ENUM_AUTO_VALUE(SEED_VARIANT_RICOSHETSHROOM)
    ENUM_AUTO_VALUE(SEED_VARIANT_RAVEBUSTER)
};
